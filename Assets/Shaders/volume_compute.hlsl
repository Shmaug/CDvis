...
#pragma multi_compile FILL PAINT GROW SHRINK PRECOMPUTE

#pragma multi_compile LIGHT_DIRECTIONAL LIGHT_SPOT LIGHT_POINT
#pragma multi_compile PLANE
#pragma multi_compile MASK

#define RootSig "DescriptorTable(UAV(u0), UAV(u1)), RootConstants(num32bitconstants=27, b0), RootConstants(num32bitconstants=27, b1)"
